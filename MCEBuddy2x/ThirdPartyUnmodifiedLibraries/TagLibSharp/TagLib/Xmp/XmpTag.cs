...
#region Public Methods
		...
		public double? GetRationalNode (string ns, string name)
		{
			...
			double nom, den;
            if (double.TryParse(values[0], System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out nom) && double.TryParse(values[1], System.Globalization.NumberStyles.Float, System.Globalization.CultureInfo.InvariantCulture, out den))
            {
				if (den != 0.0)

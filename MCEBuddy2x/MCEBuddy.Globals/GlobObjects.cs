...
namespace MCEBuddy.Globals
{
    public static class GlobalDefs
    {
        ...
        public const double MAX_CONCURRENT_SPACE_REQUIRED_MULTIPLIER = 0.5; // Then multiple tasks are running what are the chances of requiring free space simultaneously
        ...
        public const double MINIMUM_CONVERTED_FILE_THRESHOLD = 0.01; // Minimum size of converted file as a % of original/remuxed file
        ...
        // Stuff to be shared across forms

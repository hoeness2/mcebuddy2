...
namespace MCEBuddy.Transcode
{
    public class ConvertWithHandbrake : ConvertBase
    {
        ...
        private List<string> supportedFrameRates = new List<string> { "5", "10", "12", "15", "23.976", "24", "25", "29.97", "30", "50", "59.94", "60" }; // TODO: We need to update this list eveytime we update Handbrake
            ...
            if (_autoDeInterlacing)
            {
                ...
                else if (_videoFile.VideoScanType == ScanType.Interlaced)
                {
                    ...
                    if (hardwareEncodingAvailable && _preferHardwareEncoding)
                        ...
                        ParameterValueReplaceOrInsert("--deinterlace", ""); // needed for quality
                    ParameterValueReplaceOrInsert("--decomb", ""); // This also deinterlaces selectively
                }

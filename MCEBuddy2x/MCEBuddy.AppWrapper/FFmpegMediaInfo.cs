...
namespace MCEBuddy.AppWrapper
{
    ...
    public class FFmpegMediaInfo : Base
    {
        ...
        private ulong IDET_SKIP_SECONDS = 300; // Skip the first x seconds while detecting the interlace mode in a video (skip the initial parts of the video)
        private ulong IDET_ANALYZE_SECONDS = 120; // Number of seconds of the video to analyze
